...
class UploadFileImportUpdateImagesSkus(APITestCase):
    ISSUE_KEY = 'CATALOGUE-657'
    FOLDER = '/Import/UploadFileImportUpdateImagesSkus'
    ...
    def setUp(self):
        ...
        self.patcher_signal = patch(
            'catalog.services.imports.file_import.signals.update_images_skus_import_signal.send')
    ...
    def test_return400__Invalid_Version(self):
        fake.misc(data_type='import_type', code='update_images_skus', config='{"version":3}')
