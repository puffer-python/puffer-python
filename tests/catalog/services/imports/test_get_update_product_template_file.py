...
class GenerateUpdateProductTemplateTestCase(APITestCase, TestGetTerminalGroup):
    ISSUE_KEY = 'CATALOGUE-608'
    ...
    def test_200_returnValidExcelFile(self):
        with logged_in_user(self.user):
            ...
            headers = LambdaList(
                wb['Update_SanPham'][service.TITLE_ROW_OFFSET + 1]).take(20).map(lambda x: x.value).list()
